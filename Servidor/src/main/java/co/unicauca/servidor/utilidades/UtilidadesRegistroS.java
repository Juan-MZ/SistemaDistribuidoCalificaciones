...
import sop_corba.ControladorCalificacionIntHelper;

public class UtilidadesRegistroS {
    public static void registrarObjetoRemoto(String[] vectorDatosNS, ControladorGestorCalificacionesImpl objRemoto,
            String idObjetoRemoto) throws ServantNotActive, WrongPolicy, org.omg.CORBA.ORBPackage.InvalidName,
        ...
        ControladorCalificacionInt href = ControladorCalificacionIntHelper.narrow(obj);
