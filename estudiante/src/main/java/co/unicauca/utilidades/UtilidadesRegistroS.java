...
public class UtilidadesRegistroS {
    public static void registrarObjetoRemoto(String[] vectorDatosNS, ControladorGestorAlertasImpl objRemoto,
        ...
        ControladorAlertaInt href = ControladorAlertaIntHelper.narrow(obj);
